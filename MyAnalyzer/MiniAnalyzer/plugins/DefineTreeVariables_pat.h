...
//muon variables
std::vector<bool>  Mu_hasTriggered;
...
/* std::vector<int> Jet_num_ele; */
/* std::vector<float> Jet_pt_ele; */
/* std::vector<float> Jet_px_ele; */
/* std::vector<float> Jet_py_ele; */
/* std::vector<float> Jet_pz_ele; */
/* std::vector<float> Jet_en_ele; */
/* std::vector<float> Jet_phi_ele;   */
/* std::vector<float> Jet_eta_ele; */
/* std::vector<int> Jet_charge_ele; */

/* std::vector<int> Jet_num_mu; */
/* std::vector<float> Jet_pt_mu; */
/* std::vector<float> Jet_px_mu; */
/* std::vector<float> Jet_py_mu; */
/* std::vector<float> Jet_pz_mu; */
/* std::vector<float> Jet_en_mu; */
/* std::vector<float> Jet_phi_mu;   */
/* std::vector<float> Jet_eta_mu; */
/* std::vector<int> Jet_charge_mu; */
...
double eventi_Minv_wpdfNNPDF;
double eventi_Minv_wpdfMSTW;
...
/* std::vector<float> tAllJet_pt; */
/* std::vector<float> tAllJet_eta; */
/* std::vector<float> tSecondMuon; */
/* std::vector<float> tFirstMuon; */
/* std::vector<float> tDeltaR_2mu; */
/* std::vector<float> tDiJetmass; */
/* std::vector<float> tEtaPerEtaJet; */
/* std::vector<float> tDRJetJet; */

/* std::vector<float> tMass_2mucut; */
/* std::vector<float> tMass_MEtcut; */
/* std::vector<float> tMass_final_1jet; */
/* std::vector<float> tMass_final_jetVeto; */
  
/* std::vector<float> tMEt_2mucut; */
/* std::vector<float> tMEt_MEtcut; */
  
/* std::vector<float> tJet_pt_2mucut; */
/* std::vector<float> tJet_eta_2mucut; */
/* std::vector<float> tJet_bDisc_2mucut; */
/* std::vector<float> tJet_pt_MEtcut; */
/* std::vector<float> tJet_eta_MEtcut; */
/* std::vector<float> tJet_bDisc_MEtcut; */
/* std::vector<float> tJet_pt_bcut; */
/* std::vector<float> tJet_eta_bcut; */
/* std::vector<float> tJet_bDisc_bcut; */

/* std::vector<float> tJet_Leadingpt_bcut; */
/* std::vector<float> tJet_LeadingptL7_bcut; */
/* std::vector<float> tJet_Leadingeta_bcut; */
/* std::vector<float> tJet_LeadingbDisc_bcut; */
/* std::vector<float> tJet_Secondpt_bcut; */
/* std::vector<float> tJet_SecondptL7_bcut; */
/* std::vector<float> tJet_Secondeta_bcut; */
/* std::vector<float> tJet_SecondbDisc_bcut; */

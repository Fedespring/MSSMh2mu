...
config.General.requestName = 'NTuple_mc_DYJetsToLL_M-50_asymptotic_Moriond17_nlo'
...
config.Data.outputDatasetTag =  'NTuple_mc_DYJetsToLL_M-50_asymptotic_Moriond17_nlo'

...
process.muonMatchHLTL3 = cms.EDProducer("PATTriggerMatcherDRLessByR",
                                        ...
                                        matchedCuts = cms.string( 'path("HLT_IsoMu24_v*")  || path("HLT_IsoMu22_eta2p1_v*") || path("HLT_IsoTkMu22_eta2p1_v*") || path("HLT_IsoTkMu24_v*")|| path("HLT_Mu50_v*") || path("HLT_TkMu50_v*")' ),
...
process.analysis = cms.EDAnalyzer("MiniAnalyzer",
                                  ...
                                  pathNames_lowUnpr = cms.string("HLT_Mu50_v*"), 
                                  pathNames_lowTkUnpr = cms.string("HLT_TkMu50_v*"), 
                                  ...
                                  MCtruth = mc,
                                  Signal = signal,
                                  youwantAnalysis= cms.bool(False),
                                  youwantNTuples  = cms.bool(True),
...
process.TFileService = cms.Service('TFileService', 
                                   ...
                                   #fileName=cms.string('ggH125_syncr.root'),
